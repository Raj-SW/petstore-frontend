  ...
  return (
    <Container className="ServicePageContainer d-flex flex-column justify-content-center align-items-center">
      <Row className="rounded-4 w-100 border p-3 text-center mt-5 mb-5">
        ...
        at dignissimos magnam praesentium odio ducimus nulla maiores consectetur
        adipisci voluptate quod.
      </Row>
      ...
      <Row className="Service1Description w-100 d-flex flex-wrap align-items-center p-4">
        <Col className="description1 col-12 col-lg-9 pe-lg-4 text-center text-lg-start ">
          ...
          <p className="mb-3">
            ...
            sites like Facebook, Preloved, Pets4Homes, and Gumtree.
          </p>
          <br />
          <br />
          <p className="mb-3">
          ...
          <p className="mb-3">
            ...
            control of the process. We&apos;re also helping to reduce the number
            of animals going into shelters. This frees up space and resources
            for the pets who have been abandoned, need immediate help, or
        ...
        <Row className="VetServices d-flex align-items-center p-3">
          ...
          <Col md={6}>
            ...
            <p>
              ...
              relationship (HDR) important and necessary for domestic dogs. This
              relationship has expanded into an interaction where dogs are not
              solely considered companion animals but “service animals” for
              humans with special needs such as blindness, deafness, locomotion
              problems, or various conditions such as cardiovascular
              pathologies, epilepsy, diabetes, depression, and autism.
            </p>
            <br />
            <br />
            <Button
