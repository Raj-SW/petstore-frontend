...
| P9 | **Gallery detail** | refactor; admin sectioning; breadcrumb (F1) | High | **DONE (visual)** (2026-06-19, browser-verified) — full-bleed hero, floating content card (Back-to-Gallery, script title, date/location, hashtags, rich body), "Event details" sidebar. **Optional remaining:** admin sectioning (same as P7). |
